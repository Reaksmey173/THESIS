...
The hospital employs more than two hundred medical professionals, Cambodian and international, representing over twenty nationalities, and treats Cambodian families, expatriates, company employees and travellers. The hospital's services are delivered in partnership with more than forty insurance providers, which makes the Guarantee of Payment process a routine part of daily work rather than an occasional task \cite{intercare}.
...
\begin{enumerate}
    \item To identify what the system needs to protect, and to establish the security requirements of the workflow through structured engagement with the hospital's clinical, financial, and administrative stakeholders, including the separations between roles that already exist in hospital practice.
...
\section{Graduation Project Report Structure}
\label{sec:intro-structure}

This Graduation Project Report is organised into seven chapters.
...
\begin{itemize}
    ...
    \item Chapter \ref{chap:met} sets out the method, including the stakeholder-driven process used to understand the workflow, the frameworks applied, and how far each one was used.
    ...
    \item Chapter \ref{chap:conclusion} covers the difficulties encountered, a reflection on what the placement changed personally, for the team, and for the hospital, the conclusions drawn, and the work that remains.
\end{itemize}
