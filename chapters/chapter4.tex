...
Two frameworks in the table were not used. The CIS Docker Benchmark checks how containers are set up and run. The OWASP Testing Guide sets out how to carry out a penetration test. Both belong to work that comes after deployment, and neither had been done when this was written. Both have since been carried out by Canadia Bank, described in Section \ref{sec:ps-scope}, and their relationship to these two specific frameworks was judged settled enough not to need further tracking in Section \ref{sec:conc-future}.
